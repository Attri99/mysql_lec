...
CONSTRAINT fk_cust FOREIGN KEY(cust_id) REFERENCES tbl_customer(cust_id) ON DELETE SET NULL,
CONSTRAINT fk_book FOREIGN KEY(book_id) REFERENCES tbl_book(book_id) ON DELETE CASCADE
...
FROM tbl_customer c INNER JOIN tbl_order o
  ...
  ON o.book_id = b.book_id
GROUP BY c.cust_id, c.cust_name
ORDER BY SUM(b.price * o.amount) DESC
   LIMIT 1, 2;